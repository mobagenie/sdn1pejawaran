YT.updateManager = {
    ...
    updateChannelID: function (e) {
        ...
        $("#yt_embed").val('<iframe height="80px" width="300px" frameborder="0" src="https://livecounts.mobagenie.id/youtube/subscribers/embed/#!/' + YT.live.channelID + '" style="border: 0; width:300px; height:80px; background-color: #FFF;"></iframe>');
    }
};