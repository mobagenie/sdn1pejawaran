YT.sharing = {
    ...
    twitter: function () {
        window.open("https://twitter.com/intent/tweet?original_referer=" + YT.sharing.getEncodedURL() + "&ref_src=twsrc%5Etfw&text=" + YT.sharing.getText() + "&tw_p=tweetbutton&via=mobagenie.id&url=" + YT.sharing.getEncodedURL());
    },
    compare: function () {
